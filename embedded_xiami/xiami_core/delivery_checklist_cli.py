...
from xiami_core.delivery_checklist import (
    ...
    dumps_delivery_checklist,
    format_delivery_checklist,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Show Xiami online delivery checklist.")
    ...
    checklist = build_delivery_checklist(
    ...
    print(dumps_delivery_checklist(checklist) if args.json else format_delivery_checklist(checklist))
    return 1 if args.strict and not checklist.ok else 0
